...
const navigation = {
  ...
  social: [
    {
      name: 'GitHub',
      href: 'https://github.com/SOULTWARE',
    ...
    {
      name: 'LinkedIn',
      href: 'http://linkedin.com/company/soultware',
      icon: (props: React.ComponentProps<'svg'>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/soultware/',
      icon: (props: React.ComponentProps<'svg'>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 sm:py-16">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200/50 dark:border-gray-800/50">
          ...
          <p className="text-center text-sm mt-2">
            <span className="text-gray-600 dark:text-gray-400">Made with ❤️ by </span>
            <a
              href="https://soultware.com"
              target="_blank"
              rel="noopener noreferrer"
