      ...
      <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-8 rounded-lg shadow-sm">
          {isSubmitted ? (
            <div className="text-center py-6 sm:py-8">
              <div className="text-lg sm:text-xl font-semibold mb-2 text-green-600 dark:text-green-400">
              ...
              <button
                ...
                className="mt-4 text-green-600 dark:text-green-400 hover:underline text-sm sm:text-base"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  } bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500`}
                />
                {errors.name && (
                  <p className="mt-1 text-xs sm:text-sm text-red-500 dark:text-red-400">{errors.name}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.email && (
                  <p className="mt-1 text-xs sm:text-sm text-red-500 dark:text-red-400">{errors.email}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.message && (
                  <p className="mt-1 text-xs sm:text-sm text-red-500 dark:text-red-400">{errors.message}</p>
                )}
              </div>

              <button
                type="submit"
                className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 sm:py-2.5 px-4 rounded-md transition-colors duration-300 text-sm sm:text-base"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-8 rounded-lg shadow-sm">
          ...
          <div className="aspect-square bg-gray-100 dark:bg-gray-700 rounded-lg mb-4 sm:mb-6">
            <div className="h-full flex items-center justify-center text-sm sm:text-base text-gray-400 dark:text-gray-500">
              Map Coming Soon
            </div>
          </div>
          {/* Contact Information */}
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                Email: hello@beanandbyte.com<br />
                Phone: (555) 123-4567
              </p>
            </div>
          </div>
