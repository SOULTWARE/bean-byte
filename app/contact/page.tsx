  ...
  return (
		<div className="space-y-8 sm:space-y-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8">
			...
			<div className="grid md:grid-cols-2 gap-8 sm:gap-12">
				{/* Contact Form */}
				<div ref={formRef} className="bg-white dark:bg-gray-800 p-4 sm:p-8 rounded-lg shadow-sm">
					{isSubmitted ? (
						...
						<form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
							<div>
								...
								<input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base rounded-md border ${errors.name ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'} bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors duration-200`} />
							...
							<div>
								...
								<input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base rounded-md border ${errors.email ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'} bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors duration-200`} />
							...
							<div>
								...
								<textarea id="message" name="message" rows={4} value={formData.message} onChange={handleChange} className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base rounded-md border ${errors.message ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'} bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors duration-200`} />
				...
				{/* Map Section */}
				<div ref={infoRef} className="bg-white dark:bg-gray-800 p-4 sm:p-8 rounded-lg shadow-sm">
